package com.ecsolutions_erp.cadastros.configuration.security;

import com.ecsolutions_erp.cadastros.model.attributes.SecurityAttributes;
import com.ecsolutions_erp.cadastros.model.dtos.security.AuthenticatedUser;
import com.ecsolutions_erp.cadastros.model.dtos.security.KeycloakApplicationAttributes;
...
public class KeycloakAuthenticationManager implements AuthenticationManager {
    ...
    public KeycloakApplicationAttributes keycloakApplicationAttributes(UserInfo userInfo, ObjectMapper objectMapper) {
        ...
        return KeycloakApplicationAttributes.builder().type(TipoAcessoKeycloakEnum.ANONYMOUS).build();
    }
